 ...
 */
final class Version20220615162448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE component (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, is_mandatory TINYINT(1) NOT NULL, title VARCHAR(255) DEFAULT NULL, question LONGTEXT DEFAULT NULL, helper_text LONGTEXT DEFAULT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
