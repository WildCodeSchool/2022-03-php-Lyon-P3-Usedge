 ...
 */
final class Version20220705130623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer_request (id INT AUTO_INCREMENT NOT NULL, research_request_id INT DEFAULT NULL, answer LONGTEXT NOT NULL, name VARCHAR(255) DEFAULT NULL, INDEX IDX_73D740EE8664BECD (research_request_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
